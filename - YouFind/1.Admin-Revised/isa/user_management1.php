	...
	<body>
		...
		<div class="whole-wrapper">
			...
			<div class="content-right">
				...
				<p class="pending-applications">YouFind Users</p>
					<ul class="ul-user-counter">
						<li class="all">All (25)</a></li>
						<li class="customer" >Customers (15)</a></li>
						<li class="seller">Entrepreneurs (10)</a></li>
					</ul>
...
<?php
	include('admin-page-actions/admin-view-files-action.php');
?>
