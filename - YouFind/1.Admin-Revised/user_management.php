			...
			<div class="content-right">
				...
				<div class="user-counter-wrapper">
					<ul class="ul-user-counter">
						<li class="all" style="padding: 0 0 0 15px;"><a>All</a></li>
						<li class="customer" style="padding: 0 0 0 15px;"><a>Customers</a></li>
						<li class="seller" style="padding: 0 0 0 15px;"><a>Entrepreneurs</a></li>
					</ul>
