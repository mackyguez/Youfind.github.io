<?php 
	...
	$query = 'SELECT * FROM index_newsfeed_tbl WHERE product_id = '.$product_id.'';
...
<!--SELLER'S VIEW-->
	...
	<div class="whole-wrapper">
		<div class="header-holder"><?php include('header-online.php'); ?></div>

		<div class="content-holder">

			<div class="directory">
				<a class="direct-a" href="index.php">Home</a> / <a class="direct-a" href="#">Laptops & Computers</a> / <a class="direct-a" href="index.php">Laptop</a> / <?php echo @$result[0]['product_name']; ?>
			</div>
			...
			<div class="top-info">
				...
				<p class="prod-title"><?php echo @$result[0]['product_name']; ?></p>
				<button class="edit-prod">Edit Product</button>
				</div>
			</div>
			...
			<div class="bottom-info">
					...
					<div class="item-photos">
						...
						<div class="item-list">
							<ul>
								<li class="photo-list"><img src="../product-photo/<?php echo @$result[0]['product_photo']; ?>" width="50px" height="50px">
								<li class="photo-list"><img src="../product-photo/<?php echo @$result[0]['product_photo']; ?>" width="50px" height="50px">
								<li class="photo-list"><img src="../product-photo/<?php echo @$result[0]['product_photo']; ?>" width="50px" height="50px">
							</ul>
						</div>
						<div class="item-preview"><img src="../product-photo/<?php echo @$result[0]['product_photo']; ?>" width="100%" height="100%"></div>
					</div>
					...
					<div class="item-info">
						<div class="item-overview">
							...
							<ul>
								<li class="overview">1 Year Local Manufacturer Warranty
								<li class="overview">1 Year Local Manufacturer Warranty
								<li class="overview">1 Year Local Manufacturer Warranty
								<li class="overview">1 Year Local Manufacturer Warranty
								<li class="overview">1 Year Local Manufacturer Warranty
						...
						<div class="price-wrapper">
							<p class="price"><?php echo @$result[0]['product_price']; ?></p>
						</div>
			...
			<div class="prod-description">
				...
				<p class="desc-details">1 x Lenovo IdeaPad 310-14IKB<br>1 x User Manual<br>1 x Charger<br>1 x Laptop Bag</p>

				</div>

				<div class="desc-div">
					
				<p class="desc-what">General Fetures</p>
				<p class="desc-details">1 x Lenovo IdeaPad 310-14IKB<br>1 x User Manual<br>1 x Charger<br>1 x Laptop Bag</p>
			...
			<div class="review-wrapper">
				<p class="desc-title">Product Reviews</p>
				<div class="review-1">
