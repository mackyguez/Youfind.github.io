	...
	<body>
		...
		<div class="whole-wrapper">
			<div class="navigation-left">
				...
				<div class="navigation-links-holder">
					<ul class="ul-link">
						...
						<li><a href="sales_management.php" class="li-link sales">Sales Management</a></li>
			...
			<div class="content-right">
				<div class="white-progress">Home > User Management</div>
				<div class="user-management-title">User Management Page</div>
				...
				<div class="user-counter-wrapper">
					...
					<div class="apply-action-holder">
							<div class="action-selection-wrapper">
								<select id="action_selection" name="action_selection" class="action-selection">
									<?php  $actions = array('No Action','Verify','Delete', 'Ban');
							...
							<input type="button" name="apply" id="apply" class="apply-button" value="Apply">
							<input type="button" name="apply_to_all" id="apply_to_all" class="apply-to-all-button" value="Apply to All">
					</div>
				...
				<div class="users-table-content">
					<div id="table_content" class="table-content">
						<table class="fetch-data-table" id="fetch_data_table" width="1015px" style="text-align: center;">
						</table>
					</div>
				</div>
			</div>
...
<div id="view_files_modal" class="modal fade" role="dialog">
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal">&times;</button>
				<h4 class="modal-title"><span id="change_title"></span>View Files</h4>
			</div>
			<div class="modal-body" style="overflow: hidden;">
				<div id="user-info">User Information</div>
			</div>
			<div class="modal-footer">
				<button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
			</div>
